...
class Business:
    ...
    def create_coef_matrix(
        ...
        return list_coef, list_ai, list_params

    def create_ai_list_with_coef(
        self, list_coef: np.ndarray, list_ai: list[str], used_metric: list[str], list_params: list[str]
    ...
    def rank_ais(self, run_page: PagedList[Run], used_metric: list[str]) -> Optional[list]:
        ...
        if create_coef is None:
            return None
        list_coef, list_ai, list_params = create_coef

        list_ranking = self.create_ai_list_with_coef(list_coef, list_ai, used_metric, list_params)
